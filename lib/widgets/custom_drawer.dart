...
import 'package:loja_codedata/tiles/drawer_tile.dart';
                ...
                child: Stack(
                  children: [
                    Positioned(
                      top: 8.0,
                      left: 0.0,
                      child: Text("Flutter Loja", style: TextStyle(fontSize: 34.0, fontWeight: FontWeight.bold, color: Theme.of(context).primaryColor),),
                    ),
                    Positioned(
                      left: 0.0,
                      bottom: 0.0,
