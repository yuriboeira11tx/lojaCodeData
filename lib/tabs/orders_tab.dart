...
import 'package:loja_codedata/tiles/order_tile.dart';
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text("Faça o Login Para Acompanhar", style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
            SizedBox(height: 16.0),
            RaisedButton(
